...
<head>
    <meta charset="UTF-8">
    <title>Ответ Гайнутдинова Ильгизара Халилевича</title>
...
<div class="top">
    <header>
        <a href="#" target="_blank" title="Перейти на сайт хостинг-провайдера" class="logo">
    ...
    <main>
        ...
        <div class="alert alert-success">
            ...
            <div class="text">
                <h1>Задания от ГУД технологии</h1>
                <ul>
                <li>Часть 1. Что выведет следующий код? <strong>Ответ: 1</strong></li>
